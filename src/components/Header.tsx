    ...
    <header className="fixed top-0 left-0 right-0 bg-black/95 border-b border-gray-800 z-50">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          <button className="bg-[#9FE64F] hover:bg-[#8FD63F] text-black font-medium px-4 py-2 rounded-full flex items-center space-x-2">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-gray-900 rounded-lg shadow-lg py-1 border border-gray-800">
                <div className="px-4 py-3 border-b border-gray-800">
                  <p className="text-sm font-medium text-white">ProGamer123</p>
                  <p className="text-xs text-gray-400">pro@gamefolio.com</p>
                </div>
                ...
                <div className="border-t border-gray-800 mt-1">
                  <button className="w-full px-4 py-2 text-sm text-red-400 hover:bg-gray-800 flex items-center space-x-2">
