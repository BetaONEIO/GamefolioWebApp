/*
  ...
  1. Changes
     - Update username validation to allow uppercase letters
     - Modify the validation function to accept uppercase characters
     - Update the regex pattern to include uppercase letters
     - Keep other validation rules (length, starting with letter, etc.)
